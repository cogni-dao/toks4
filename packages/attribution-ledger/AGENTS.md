...
- **Exports:**
  ...
  - `SettlementStore`, `ClaimantLiabilityRecord`, `SettlementRevisionRecord`, `SettlementLeafRecord`, `AppendSettlementRevisionParams` — exactly-once late-claimant settlement persistence contract
